...
Vamos a trabajar con el conjunto de datos [Heart Attack Analysis & Prediction data](https://www.kaggle.com/datasets/rashikrahmanpritom/heart-attack-analysis-prediction-dataset?resource=download)[set](https://www.kaggle.com/datasets/rashikrahmanpritom/heart-attack-analysis-predictiondataset), el cual se encuentra disponible en Kaggle.
...
Para realizar la integración y selección de datos en R con el dataset "Heart Attack Analysis & Prediction", se comienza descargando el dataset desde el enlace proporcionado. Luego, se cargan las bibliotecas necesaria.
